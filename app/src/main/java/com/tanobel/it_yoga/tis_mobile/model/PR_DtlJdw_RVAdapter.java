...
public class PR_DtlJdw_RVAdapter extends RecyclerView.Adapter<PR_DtlJdw_RVAdapter.ViewHolder> {
    private List<PR_DtlJdw> kt = new ArrayList<>();
    private Typeface font;
    private PR_Fragment_DetailJdw mFragment;
    String tipe;

    public PR_DtlJdw_RVAdapter(PR_Fragment_DetailJdw mFragment, List<PR_DtlJdw> kt, String tipe) {
        this.kt = kt;
