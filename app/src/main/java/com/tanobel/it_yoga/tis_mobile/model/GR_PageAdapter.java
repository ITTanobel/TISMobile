...
/**
 * Created by Galeh on 21/12/2022.
 */

public class GR_PageAdapter extends FragmentStatePagerAdapter {
    ...
    public GR_PageAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public CharSequence getPageTitle(int position) {
        ...
        if (fragname.indexOf("Master") != -1) {
            title = "Header";
        } else if (fragname.indexOf("Inspection") != -1) {
